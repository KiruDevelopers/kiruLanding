...
// Componente para items del manifiesto con mejor organización
const ManifestoItem = ({ title, content, isPrimary = false }) => (
    <Card 
        className={`border-0 mb-4 h-100 ${isPrimary ? 'bg-card-kiru' : 'bg-dark-kiru'}`}
        style={isPrimary ? { borderLeft: '4px solid var(--color-primary)' } : {}}
    >
        <Card.Body className="p-4">
            <h4 className="text-white mb-3 fw-bold">{title}</h4>
            <p className="text-secondary mb-0 lh-lg">{content}</p>
        </Card.Body>
    </Card>
);
        ...
        <Card className="bg-card-kiru border-0">
            <Card.Body className="p-4">
                ...
                >
                    ...
                    <p className="small text-secondary text-uppercase tracking-wider mb-4">
                        Web Developers
                    </p>
    ...
    <div className="mb-4">
        ...
        <Card className="bg-card-kiru border-0">
            <Card.Body className="p-4">
                ...
                <blockquote className="mb-4 pb-3 border-bottom border-secondary border-opacity-25">
                ...
                <Row className="align-items-center g-3">
                    <Col xs={12} md={6}>
                        <div className="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <p className="mb-0 text-secondary small text-uppercase">
                                    Web Developers
                                </p>
                            </div>
                        </div>
            ...
            <Container className="py-5">
                ...
                <Row>
                    ...
                    <Col lg={7} className="mb-4">
                        {/* Principio Principal */}
                        <Card className="bg-card-kiru border-0 mb-4" style={{ borderLeft: '4px solid var(--color-primary)' }}>
                            <Card.Body className="p-4 p-md-5">
                                <h2 className="text-white mb-3 fw-bold" style={{ color: 'var(--color-primary)' }}>
                                    Hacer menos, lograr más: claridad que acelera productos.
                                </h2>
